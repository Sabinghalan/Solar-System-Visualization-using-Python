...
Original file is located at
    https://colab.research.google.com/drive/1pWvKbsi3W34EFOB3gqJ_gKcejliWb_1P
"""
...
layout=go.Layout(title = 'Solar System', showlegend=False, margin=dict(l=0, r=0, t=0, b=0),
                  ...
                  scene = dict(xaxis=dict(title='Distance from the Sun', 
                               ...
                               zaxis=dict(title='Distance form the sun', 
                                          range=[-7000,7000],
                                          backgroundcolor='black',
                                          color='white', 
                                          gridcolor='black'
